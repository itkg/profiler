            ...
            <div class="section">
                <table id="database" class="tablesorter">
                    ...
                    <?php foreach ($data as $row) : ?>
                        <tr>
                            <td>
                                <div class="tooltip collector-database-query"
                                     title="<?= $row['query'] ?>"><?= $row['query'] ?></div>
                            </td>
                            <td class="numeric"><?= number_format($row['executionTime'], 5) ?></td>
                            <td class="numeric">
                                <div class="tooltip" title="<? print_r($row['bind']); ?>">see</div>
                            </td>
                            <td class="numeric"></td>
                        </tr>
                    <?php endforeach; ?>
